...
channel_secret = "f16e1d3cda099b1f9daecead12552295"
channel_access_token = "eCXVfgVWYM2spY/q4aBXEccYfr41w8LqvhaoQ81NcvwaPmZXdZzFXk6NtkG0JNWsz1YvjkflK0JytqFh6dMsfJNJKZtC8ezyBtFMpBbcEpxp+C82cJDNh42lFIsqyuYJYUZ2DwZs7NWcbUEkeVbTLAdB04t89/1O/w1cDnyilFU="

broker_address= "mqtt.netpie.io"
port = 1883

client = mqttClient.Client("98e3d97e-8e7b-44c5-9f07-4da3e533f97f") # Client ID
user = "Kc7xPYCEAVMrR9Mqv8jXG8BBERYpGiZo" # Token
password = ")g1REYBgYhmaFWJgKFz_UBJgtovu4Qo4" # Secret 
...
def handle_text_message(event):
    ...
    if (text=="อุณหภูมิและความชื้น"):
        ...
        if len(temp) > 0 and len(humi) > 0:
            text_out = "อุณหภูมิ " + temp +" Degree C" +" ความชื้น " + humi+" %rH"
            line_bot_api.reply_message(event.reply_token,TextSendMessage(text=text_out))
